...
export const elements = {
  ...
  battleStartBtn: $("battleStartBtn"),
  battlePauseBtn: $("battlePauseBtn"),
  battleBackBtn: $("battleBackBtn"),
  battleSpeedLabel: $("battleSpeedLabel"),
  battleTime: $("battleTime"),
  battleCount: $("battleCount"),
  battleStatus: $("battleStatus"),
  battleFormationSelect: $("battleFormationSelect"),
  battleFormationApply: $("battleFormationApply"),
  battleFormationSave: $("battleFormationSave"),
  strategyCard: $("strategyCard"),
  strategyTarget: $("strategyTarget"),
  strategyKite: $("strategyKite"),
  strategyRetreat: $("strategyRetreat"),
  strategyCharge: $("strategyCharge"),
  strategyApply: $("strategyApply"),
  rosterCard: $("rosterCard"),
  rosterStandby: $("rosterStandby"),
  rosterSortie: $("rosterSortie"),
  rosterAuto: $("rosterAuto"),
  rosterClear: $("rosterClear"),
  rosterApply: $("rosterApply"),
  rosterCount: $("rosterCount"),
  battleInfoCard: $("battleInfoCard"),
  ...
  audienceBribeBtn: $("audienceBribeBtn"),
  audienceHonorBtn: $("audienceHonorBtn"),
  audienceRequestBtn: $("audienceRequestBtn"),
  audienceResignBtn: $("audienceResignBtn"),
  audienceExitBtn: $("audienceExitBtn"),
  battlePrepRow: $("battlePrepRow"),
  battlePrepFightBtn: $("battlePrepFightBtn"),
  battlePrepRunBtn: $("battlePrepRunBtn"),
  battlePrepPrayBtn: $("battlePrepPrayBtn"),
  battlePrepSurrenderBtn: $("battlePrepSurrenderBtn"),
  battlePrepInfo: $("battlePrepInfo"),
  ...
  eventTradeModal: $("eventTradeModal"),
  eventTradeModalClose: $("eventTradeModalClose"),
  eventTradeTableBody: $("eventTradeTableBody"),
  eventTradeConfirm: $("eventTradeConfirm"),
  eventTradeDelta: $("eventTradeDelta"),
  eventTradeFunds: $("eventTradeFunds"),
  eventTradeError: $("eventTradeError"),
  eventTradeTitle: $("eventTradeTitle"),
  ...
  codexFilterWrap: $("codexFilterWrap"),
  bribeModal: $("bribeModal"),
  bribeModalClose: $("bribeModalClose"),
  bribeInput: $("bribeInput"),
  bribeFunds: $("bribeFunds"),
  bribeError: $("bribeError"),
  bribeConfirm: $("bribeConfirm"),
  bribeCancel: $("bribeCancel"),
  ...
  eventModalActions: $("eventModalActions"),
  questBody: $("questBody"),
  questList: $("questList"),
  questModal: $("questModal"),
  questModalClose: $("questModalClose"),
  questModalBody: $("questModalBody"),
  nobleQuestModal: $("nobleQuestModal"),
  nobleQuestModalClose: $("nobleQuestModalClose"),
  nobleQuestModalBody: $("nobleQuestModalBody"),
  hireModal: $("hireModal"),
  ...
  battleResultModal: $("battleResultModal"),
  battleResultClose: $("battleResultClose"),
  battleResultBody: $("battleResultBody"),
  battleResultBack: $("battleResultBack"),
};
