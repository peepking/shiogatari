...
export const OUTFITTING_ITEMS = freezeDefinition({
  ...
  fire_ballista: { name: "ファイヤバリスタ", category: "attack", price: 15000, attack: { interval: 15, power: 180 } },
  grape_ballista: { name: "ブドウ弾バリスタ", category: "attack", price: 15000, attack: { interval: 6, power: 30, allEnemies: true } },
  fire_grape_ballista: { name: "火炎ブドウ弾バリスタ", category: "attack", price: 15000, attack: { interval: 12, power: 70, allEnemies: true } },
  cannon: { name: "砲撃支援", category: "attack", price: 25000, attack: { interval: 20, power: 300 } },
